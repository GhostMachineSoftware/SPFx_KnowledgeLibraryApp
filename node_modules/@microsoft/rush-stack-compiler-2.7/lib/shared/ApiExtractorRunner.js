...
class ApiExtractorRunner extends RushStackCompilerBase_1.RushStackCompilerBase {
    ...
    invoke() {
        try {
            const extractorOptions = Object.assign({}, this._extractorOptions, { customLogger: {
            ...
            const extractor = new api_extractor_1.Extractor(this._extractorConfig, extractorOptions);
